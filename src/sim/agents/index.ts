...
export { compactAgentMemoryRecords, compactRelationshipRecords, createAgent, eligibleAgentCount, MAX_AGENT_MEMORY_IDS, MAX_BELIEFS_PER_AGENT, MAX_DETAILED_AGENTS, MAX_RELATIONSHIP_RECORDS, MAX_RELATIONSHIPS_PER_AGENT, stepAgents } from "./lifecycle.ts";
