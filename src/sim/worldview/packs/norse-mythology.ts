...
export const norseMythology: WorldviewPack = {
  ...
  rules: [
    ruleFromPredicates("norse-storm-discovery", [{ subject: "field", metric: "meanHumidity", operator: ">=", value: 0.4 }, { subject: "population", metric: "populationCount", operator: ">=", value: 6 }], 0.09, (_context, evidence) => ({ kind: "discover-motif", packId: "mythology.norse-motif", motifId: "storm-oath", regionId: "region:origin" as never, evidence })),
    ruleFromPredicates("norse-cycle-discovery", [{ subject: "field", metric: "meanTemperature", operator: "<=", value: 0.4 }, { subject: "culture", metric: "knowledgeDiversity", operator: ">=", value: 1 }], 0.06, (_context, evidence) => ({ kind: "propose-entity", packId: "mythology.norse-motif", entityKind: "deity", regionId: "region:origin" as never, evidence, probability: 0.06 })),
  ],
