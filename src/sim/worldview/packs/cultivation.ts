...
export const cultivation: WorldviewPack = {
  ...
  rules: [
    ruleFromPredicates("cultivation-discovery", [{ subject: "chemistry", metric: "oxygen", operator: ">=", value: 0.03 }, { subject: "culture", metric: "knowledgeDiversity", operator: ">=", value: 2 }, { subject: "population", metric: "cognitivePotential", operator: ">=", value: 1 }], 0.05, (context, evidence) => ({ kind: "propose-entity", packId: "cultivation.path", entityKind: "cultivation-path", regionId: regionIdForWorldview(context), evidence, probability: 0.05 })),
    ruleFromPredicates("cultivation-lineage", [{ subject: "organization", metric: "organizationCapacity", operator: ">=", value: 6 }, { subject: "culture", metric: "knowledgeDiversity", operator: ">=", value: 2 }], 0.04, (context, evidence) => ({ kind: "discover-motif", packId: "cultivation.path", motifId: "lineage-transmission", regionId: regionIdForWorldview(context), evidence })),
  ],
